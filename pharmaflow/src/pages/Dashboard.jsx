...
import { Clipboard, TrendingUp, Package, DollarSign } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <Card title="Growth Rate" value="8.5%" icon={TrendingUp} />
        <Card title="Products Sold" value="12,345" icon={Package} />
        <Card title="Prescriptions" value="7,890" icon={Clipboard} />
      </div>
