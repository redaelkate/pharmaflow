...
const Teams = () => {
  ...
  <input class="peer hidden" type="checkbox" name="select-1" id="select-1" checked />
  <label for="select-1" class="flex w-full cursor-pointer select-none rounded-lg border p-2 px-3 text-sm text-gray-700 ring-blue-400 peer-checked:ring">Select Option </label>
  ...
  <ul class="max-h-0 select-none flex-col overflow-hidden rounded-b-lg shadow-xl transition-all duration-300 peer-checked:max-h-56 peer-checked:py-3">
    <li class="cursor-pointer px-3 py-2 text-sm text-gray-500 hover:bg-blue-500 hover:text-white">Nikola Tesla</li>
    <li class="cursor-pointer px-3 py-2 text-sm text-gray-500 hover:bg-blue-500 hover:text-white">Lorem Ipsanum</li>
    <li class="cursor-pointer px-3 py-2 text-sm text-gray-500 hover:bg-blue-500 hover:text-white">Alber Einstein</li>
  </ul>
</div>
    <hr class="mt-4 mb-8" />
    <p class="py-2 text-xl font-semibold">Password</p>
...
<div class="mx-1 min-h-screen max-w-screen-xl sm:mx-8 xl:mx-auto">
  ...
  <div class="grid grid-cols-8 pt-3 sm:grid-cols-10">
    ...
    <div class="col-span-2 hidden sm:block">
      <ul>
          {['Teams', 'Accounts', 'Users', 'Profile', 'Billing', 'Notifications', 'Integrations'].map(linkName => {
            return (
                <li key={linkName} class={`mt-5 cursor-pointer border-l-2 border-transparent px-2 py-2 font-semibold transition hover:border-l-blue-700 hover:text-blue-700 ${activeLink === linkName ? 'border-l-blue-700 text-blue-700' : ''}`} onClick={() => setActiveLink(linkName)}>
                {linkName}
                </li>
            )
        })}
        ...
        {activeLink === 'Accounts' && Accounts()}
        {activeLink === 'Teams' && Teams()}
